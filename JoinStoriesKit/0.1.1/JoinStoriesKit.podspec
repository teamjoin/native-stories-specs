...
Provides UI to display stories thumbnails, full screen stories.
  ...
  s.homepage         = 'https://github.com/teabow/native-stories'
  s.license          = { :type => 'MIT', :file => 'LICENSE' }
  s.author           = { 'teabow' => 'thibaud.bourgeois@gmail.com' }
  s.source           = { :git => 'https://github.com/teabow/native-stories.git', :tag => s.version.to_s }
  s.swift_version    = '5.0'

  s.ios.deployment_target = '10.0'

  s.source_files = '**/StoriesKit/**/*'
  
  # s.resource_bundles = {
  #   'JoinStoriesKit' => ['JoinStoriesKit/Assets/*.png']
  # }
